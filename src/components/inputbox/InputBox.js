...
export default function InputBox({
    ...
    return (
        <View style={{ width: '100%', height: 64, backgroundColor: '#fff', paddingLeft: 20, borderRadius: 5 }}>
            <Text style={{ position: 'absolute', top: isFocus || value !== '' ? 7 : 22, bottom: 0, left: 20, fontSize: isFocus || value !== '' ? 11 : 14, bottom: 0, fontFamily: 'Poppins-Medium', color: '#9B9B9B' }}>{changeText}</Text>
