...
function YouMayAlsoLike({item}) {
    ...
    return (
        <Pressable
            ...
            style={{ backgroundColor: '#fff', width: deviceWidth / 2 - 19, height: 284, borderRadius: 15, alignItems: 'stretch', paddingVertical: 20, paddingHorizontal: 10, marginTop: 12, margin: 5 }}
        >
