...
export default function PaymentConfirmation({ scrollRight, nativeDriver }) {
    ...
    return (
        <Animated.View style={{ ...StyleSheet.absoluteFillObject, transform: [{ translateX: scrollRight }], flex: 1, backgroundColor: '#f1f1f1', zIndex: 1 }}>
            <View style={{ height: 95, width: deviceWidth, backgroundColor: '#fff', alignItems: 'center', justifyContent: 'flex-end' }}>
            ...
            <ScrollView showsVerticalScrollIndicator={false} scrollEventThrottle={16}>
                ...
                <View style={{ backgroundColor: '#fff', paddingLeft: 10, paddingRight: 15, marginTop: 8, paddingVertical: 5 }}>
                    <View>
                ...
                <View style={{ backgroundColor: '#fff', paddingLeft: 10, paddingRight: 15, marginTop: 21.5, paddingTop: 10, paddingBottom: 28 }}>
                    <View>
                ...
                <PaymentMethod value={0} marginTop={20} select={select} />
                {/* Payment Details ends here... */}

                <View style={{ height: 119, width: deviceWidth, marginBottom: 45, flexDirection: 'row', justifyContent: 'space-between', paddingHorizontal: 33, paddingTop: 20 }}>
                    ...
                    {select ? (
                        <Pressable onPress={() => alert(123)} style={{ backgroundColor: '#000000', width: 115, height: 28, alignItems: 'center', justifyContent: 'center', borderRadius: 8 }}>
                            <Text style={{ fontFamily: 'Poppins-Bold', fontSize: 11, color: '#fff' }}>Place Order</Text>
                        </Pressable>
                    ) : (
                        <Pressable onPress={() => alert(123)} disabled={true} style={{ backgroundColor: !select && '#D5D5D5', width: 115, height: 28, alignItems: 'center', justifyContent: 'center', borderRadius: 8 }}>
                            <Text style={{ fontFamily: 'Poppins-Bold', fontSize: 11, color: !select && '#f1f1f1' }}>Place Order</Text>
                        </Pressable>
                    )}
                </View>
                {/* tabBar starts here... */}
